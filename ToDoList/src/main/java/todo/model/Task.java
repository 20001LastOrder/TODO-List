...
public class Task
{
  ...
  public Task(String aName, Date aEndDate, int aPriority, String aDescriprion, Catagory aCatagory)
  {
    name = aName;
    endDate = aEndDate;
    priority = aPriority;
    ...
    boolean didAddCatagory = setCatagory(aCatagory);
    if (!didAddCatagory)
    {
      throw new RuntimeException("Unable to create task due to catagory");
    }
  }
  ...
  public boolean setCatagory(Catagory aCatagory)
  {
    boolean wasSet = false;
    if (aCatagory == null)
    {
    ...
    Catagory existingCatagory = catagory;
    catagory = aCatagory;
    if (existingCatagory != null && !existingCatagory.equals(aCatagory))
    {
      existingCatagory.removeTask(this);
    }
    catagory.addTask(this);
    wasSet = true;
    return wasSet;
  }
  ...
  public void delete()
  {
    ...
    Catagory placeholderCatagory = catagory;
    this.catagory = null;
    placeholderCatagory.removeTask(this);
  }
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "  " + "catagory = "+(getCatagory()!=null?Integer.toHexString(System.identityHashCode(getCatagory())):"null");
  }
}